...
EnumFormatEtcImpl::EnumFormatEtcImpl(ULONG cFE, LPFORMATETC prgFE)
{
    UINT        i;
...
EnumFormatEtcImpl::~EnumFormatEtcImpl(void)
{
    if (NULL!=m_prgfe)
        delete [] m_prgfe;
...
STDMETHODIMP EnumFormatEtcImpl::QueryInterface(REFIID riid, void **ppvObject)
{
    *ppvObject=NULL;
...
STDMETHODIMP EnumFormatEtcImpl::Next(ULONG cFE, LPFORMATETC pFE, ULONG *pulFE)
{
    ULONG               cReturn=0L;
...
STDMETHODIMP EnumFormatEtcImpl::Skip(ULONG cSkip)
{
...
STDMETHODIMP EnumFormatEtcImpl::Clone(LPENUMFORMATETC *ppEnum)
{
    ...
    *ppEnum=NULL;
    ...
    //Create the clone
    pNew=new EnumFormatEtcImpl(m_cfe, m_prgfe);
